...
// The delay parameter is in units of the core clock. (units of 45.45 nsec for 22 MHz clock)
...
// AFTER (correct for 22 MHz):
void SysTick_Wait10ms(uint32_t delay){
    uint32_t i;
    for(i=0; i<delay; i++){
        SysTick_Wait(220000);   // 22 MHz: 220,000 cycles = 10ms
    }
}
